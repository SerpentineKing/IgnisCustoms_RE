...
function s.e2evt(e,tp)
	...
	if tc and Duel.ChangePosition(tc,POS_FACEDOWN_DEFENSE)>0 then
		...
		e2b0:SetReset(RESET_EVENT+RESET_TOFIELD|RESET_LEAVE|RESET_TODECK|RESET_TOHAND|RESET_TEMP_REMOVE|RESET_REMOVE|RESET_TOGRAVE+RESET_PHASE+PHASE_DRAW+RESET_OPPO_TURN,1)
