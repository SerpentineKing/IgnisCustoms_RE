...
function s.e2evt(e,tp)
	...
	if tc and Duel.ChangePosition(tc,POS_FACEDOWN_DEFENSE)>0 then
		...
		e2b1:SetProperty(EFFECT_FLAG_CLIENT_HINT)
		e2b1:SetReset(RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DRAW+RESET_OPPO_TURN,1)
		...
		e2b2:SetReset(RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END+PHASE_DRAW+RESET_OPPO_TURN,1)
		e2b2:SetProperty(EFFECT_FLAG_CLIENT_HINT)
		e2b2:SetValue(1)
		...
		e2b3:SetReset(RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END+PHASE_DRAW+RESET_OPPO_TURN,1)
		e2b3:SetValue(1)
		tc:RegisterEffect(e2b3,true)

		local e2b4=Effect.CreateEffect(c)
		e2b4:SetType(EFFECT_TYPE_SINGLE)
		e2b4:SetCode(EFFECT_CANNOT_BE_MATERIAL)
		e2b4:SetProperty(EFFECT_FLAG_CANNOT_DISABLE)
		e2b4:SetValue(aux.cannotmatfilter(SUMMON_TYPE_FUSION,SUMMON_TYPE_SYNCHRO,SUMMON_TYPE_XYZ,SUMMON_TYPE_LINK))
		e2b4:SetReset(RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END+PHASE_DRAW+RESET_OPPO_TURN,1)
