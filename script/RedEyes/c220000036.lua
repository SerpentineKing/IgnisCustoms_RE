...
function s.e1evt(e,tp)
	...
	e1b:SetReset(RESETS_STANDARD+PHASE_END)
	e1b:SetValue(atk/2)
	...
	e1d:SetValue(1)
	e1d:SetReset(RESETS_STANDARD_PHASE_END+PHASE_BATTLE)
	Duel.RegisterFlagEffect(tp,id,RESETS_STANDARD_PHASE_END+PHASE_BATTLE,0,1)
